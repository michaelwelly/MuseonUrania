      ...
      {field.map((p, i) => {
        ...
        return (
          <g
            ...
            /* Краска фигуры — наружу атрибутом: так место на странице может
               спрятать акценты у себя, не залезая в классы этого модуля.
               Нужно полосе с формой на главной — в одну колонку её зоны
               мимо, и яркие кубики там скрыты. */
            data-ink={p.ink}
