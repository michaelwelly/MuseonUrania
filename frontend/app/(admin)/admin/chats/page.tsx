...
export default function ChatsPage() {
  ...
  // только тех, кому Урания не смогла ответить. Разговор, который идёт прямо
  ...
  return (
    <>
      ...
      <p className="admin-hint">
        Здесь видно все разговоры, свежие сверху — в том числе те, где Урания справляется
        ...
        С этого момента Урания в разговоре молчит.
      </p>
