      ...
      {hints && (
        <div className="hints">
          ...
          <div className="hints__body">
            <p className="hints__title">С чего начать сегодня</p>
            <p className="hints__text">
              Сначала разберите входящие обращения и ожидающие разговоры, затем
              проверьте материалы, которые ждут публикации. Сводка ниже покажет,
              где нужно действие; после каждого изменения статус и история сохраняются
              автоматически.
            </p>
