        ...
        <div className="hints">
          ...
          <div className="hints__body">
            ...
            <p className="hints__text">
              ...
              на сайт и не снимает его оттуда. Незаполненные поля показываются как данные,
              которые готовятся, а не заполняются автоматически. Цены, сроки поставки
              и клинические заявления наружу не идут.
            </p>
