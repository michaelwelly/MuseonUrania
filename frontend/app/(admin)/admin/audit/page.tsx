...
const ОБЪЕКТЫ = [
  ...
  "conversation",
  "media",
  // Сотрудники — предмет, под которым лежит изменение прав. Без чипа
  // единственный след «кому что выдали» приходилось искать перелистыванием
  // всего журнала, а ищут его ровно тогда, когда что-то пошло не так
  // (issue #108).
  "staff",
];
