    ...
    <div className="bell" ref={box}>
      ...
      {open && (
        <div className="bell__panel" role="dialog" aria-label="Уведомления">
          ...
          <p className="bell__wait">Уведомления пока не включены</p>
          <p className="bell__why">
            Портал уже ведёт журнал действий, но отдельный список уведомлений ещё не хранит.
          </p>
          <p className="bell__why">
            Срочные задачи смотрите на сводке и в разделе заявок. Разговоры, которые ждут
            ответа, видны в виджете внизу справа.
          </p>
        </div>
      )}
    </div>
