...
export const ui: UiStrings = {
  meta: {
    ...
    // Фраза «У каждой позиции указан статус документации» снята: бейджа
    // статуса под карточками каталога больше нет, и абзац обещал то, чего
    // на странице не увидеть. Строка служит и вводным абзацем каталога,
    // и описанием страницы для поисковика — неправда была бы в обоих местах.
    productsLead:
      "Изделия для неонатологии, реанимации, анестезиологии, мониторинга и интенсивной терапии.",
