...
export const route = {
  ...
  // координаты, а ?rtext= с текстом вместо "широта,долгота" координаты не
  // подставляет и карту к точке не подводит — только кладёт строку в поле
  // «Куда» неразрешённой. На открывшейся странице у пользователя есть кнопка
  // «Маршрут» — от неё до готового маршрута ровно один клик.
  ctaHref: `https://yandex.ru/maps/?text=${encodeURIComponent(site.address)}`,
