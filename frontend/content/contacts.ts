...
export const route = {
  ...
  // Поле cta ("Построить маршрут") убрано по GitHub issue #74: кнопка вела
  // на схему проезда, нарисованную CSS без настоящей карты, — маршрут
  // строить было неоткуда. Вернуть — вместе с подключением живой карты
  // (Яндекс.Карты), если заказчик выберет этот путь из развилки в #74.
};
