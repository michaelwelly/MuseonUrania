...
| `vedal.postman_collection.json` | Every door in one Postman import: 23 folders, 104 requests |
...
schedule, images, staff portraits, Vedalina's index. Sixty-seven routes,
eighty-seven operations.
