...
| `vedal.postman_collection.json` | Every door in one Postman import: 25 folders, 112 requests |
...
never will. Twenty-one operations, five sections.
...
schedule, images, staff portraits, Vedalina's index. Seventy routes,
ninety-one operations.
