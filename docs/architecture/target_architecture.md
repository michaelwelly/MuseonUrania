...
| 4 | Роль приложения — владелец схемы, а в стеке ещё и суперпользователь | Отзыв прав из `V15` суперпользователя не связывает вовсе: проверку прав он не проходит. Журнал держит триггер, остальные таблицы — ничто. Нужна отдельная рантайм-роль |
