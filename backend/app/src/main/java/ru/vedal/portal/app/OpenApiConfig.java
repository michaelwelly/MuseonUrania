...
public class OpenApiConfig {
    ...
    private String description() {
        return """
                ...
                Лимит форм и новых анонимных обращений считается по адресу
                клиента: формы — 5, новые разговоры с ассистентом — 20 за 10 минут.
                У уже начатого разговора свой бюджет: 60 сообщений за 10 минут
                по `visitorKey`, поэтому общий NAT клиники его не обрывает.
