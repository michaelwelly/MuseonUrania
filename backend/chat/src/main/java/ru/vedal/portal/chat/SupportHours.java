...
public class SupportHours {
    ...
    /**
     * Зона, в которой у поддержки идут часы и кончается день.
     *
     * <p>Отдаётся наружу ради графика дежурств: «сегодня» у дежурного
     * в Екатеринбурге и у машины в другом часовом поясе — разные даты,
     * и вторая никого не интересует. Взяв зону сервера, мы получили бы
     * график, который переводит смену на завтра, пока у дежурного ещё
     * вечер, — или держит вчерашнюю, когда у него уже утро.
     */
    public ZoneId zone() {
        return zone;
    }
